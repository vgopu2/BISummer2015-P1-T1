...
namespace AW.TestHarness
{
    public partial class Test : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
         ...
         ////   ProductDescription obj = new ProductDescription();
         ////   obj.ProductDescriptionID = 8;
         ////  EntityManager<Order> orde = new EntityManager<Order>();

         //   List<ProductDescription> list1 = mgrProduct.GetAll();
         //  // List<ProductDescription> list2 = mgrProduct.Search(obj);
