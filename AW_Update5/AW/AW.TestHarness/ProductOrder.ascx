    ...
    <Columns>
       ...
       <%-- <asp:TemplateField HeaderText="Total Price" >
        ...
        <asp:TemplateField HeaderText="Quantity">
            <ItemTemplate>
            <asp:DropDownList ID="ddlquantity" runat="server" onChange="SetPrice(this)">
                <asp:ListItem Text="Select Quantity" Value="00" Selected="True"></asp:ListItem>
...
<asp:Button ID="btnOrder" runat="server" Text="Add to Cart" />